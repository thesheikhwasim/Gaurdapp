    ...
    <IonPage>
      ...
      <IonGrid className='ion-margin ion-text-center'>
        <IonRow>
          ...
          <IonSelect placeholder="Select Route" fill='solid'>
                <IonSelectOption value="zoneIdA">Zone Address</IonSelectOption>
                <IonSelectOption value="zoneIdB">Zone Address</IonSelectOption>
                </IonSelect>
          </IonCol>
          <IonCol size="6" size-md="4" size-lg="6"><IonButton color="secondary" shape='round' size="small">Start Trip</IonButton></IonCol>
        </IonRow>
      </IonGrid>
      <IonList >
