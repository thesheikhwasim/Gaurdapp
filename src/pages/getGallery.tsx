...
<p><IonImg
 ...
 <IonButton  expand="full"  onClick={handlecameraStart}> {t('Add Your Selfie')}</IonButton>
        ...
        <IonItem>
          <IonButton  expand="full"  onClick={handlecameraStartone}> {t('Upload Incedent Image 1')}</IonButton>
        </IonItem>
      )}
 {!showselfie ? ( 
  <IonItem>
 <IonButton  expand="full"  onClick={handlecameraStarttwo}> {t('Upload Incedent Image 2')}</IonButton>
 </IonItem>
  ) : ( '' )}
   {!showselfie ? ( 
  <IonItem>
 <IonButton  expand="full"  onClick={handlecameraStartthree}> {t('Upload Incedent Image 3')}</IonButton>
 </IonItem>
  ) : ( '' )}
   {!showselfie ? ( 
  <IonItem>
  <IonButton  expand="full"  onClick={handlecameraStartfour}> {t('Upload Incedent Image 4')}</IonButton>
  </IonItem>
  ) : ( '' )}
   {!showselfie ? ( 
  <IonItem>
 <IonButton  expand="full"  onClick={handlecameraStartfive}> {t('Upload Incedent Image 5')}</IonButton>
 </IonItem>
  ) : ( '' )}
